...
int main(int argc, char** argv) {
    ...
    #pragma omp parallel 
    {
       ...
       #pragma omp barrier 
       // after uncommenting the line above, we can see that there is a barrier that only let the threads 
       // continue to move on after all threads finish their works
       // So, the result change from Before and After right away into finish all Befores and then Afters
