...
void getArguments(int argc, char *argv[], int * n, int * iter, 
                  int * verbose, int *numThreads)
{
 
  char *nvalue;      // number of rows
  // number of columns is same as rows for this problem
  // char *mvalue;      
...
void Usage(char *program) {
  ...
  fprintf(stderr, "Usage: %s [-n rows] [-i iterations] [-v] [-t numThreads]\n", program);
}
