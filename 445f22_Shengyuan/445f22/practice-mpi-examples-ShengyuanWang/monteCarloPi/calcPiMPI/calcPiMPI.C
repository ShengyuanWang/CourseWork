...
int main(int argc, char** argv) {
   ...
   numProcessTosses = totalNumTosses/numProcs; // how many tosses each process will complete
...
long Toss(long processTosses, int myRank){
  ...
  r.jump(2*(myRank*processTosses)); // jump ahead to my process' set of random values:
