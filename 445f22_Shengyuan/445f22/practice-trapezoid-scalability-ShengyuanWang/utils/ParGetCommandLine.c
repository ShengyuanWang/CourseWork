                  ...
                  int * numThreads)
{
  ...
  while ((c = getopt (argc, argv, "n:hvet:")) != -1) {
...
void Usage(char *program) {
  ...
  fprintf(stderr, "Usage: %s [-h] [-v] [-n numTrapezoids] [-t numThreads]\n", program);
  ...
  fprintf(stderr, "   -t indicates how many threads to use.\n");
}
