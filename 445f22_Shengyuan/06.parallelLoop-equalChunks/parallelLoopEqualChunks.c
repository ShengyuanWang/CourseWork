 ...
 *
 * NOTE: this code is slightly different from the original patternlet
 *       of the same name. It shows how we often split the pragma
 *       line for a loop into two.
 */
...
int main(int argc, char** argv) {
    ...
    // alternative and often needed method of doing the same thing:
    // two separate pragmas
    #pragma omp parallel    // indicate the fork
    {   
      int id = omp_get_thread_num();  // set up private data

      #pragma omp for       // openMP will decompose the loop
